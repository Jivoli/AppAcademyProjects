...
class List
    ...
    def print
        ...
        p "To do" if !item.state 
        p "Done" if item.state
        end
        p "------------------------------------------"
        ...
        def print_full_item(index)
            ...
            p "To do" if !@items[index].state 
            p "Done" if @items[index].state
            p "------------------------------------------"
            return nil
        end
        ...
        def remove_item(index)
            return false if !valid_index?(index)
            @items.select! {|item| item != @items[index]}
            return true
        end

        def purge
            @items.select! {|item| !item.state}
        end
